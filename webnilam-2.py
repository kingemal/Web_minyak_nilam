...
def home():
 ...
 # Contoh gambar dari Google
    st.image("Gambar produk/gambar produk minyak nilam.png", use_container_width=True)
...
def minyaknilam():
    ...
    Jenis_Penyulingan = st.text_input("Masukkan Jenis Penyulingan")
    Jumlah_minyak = st.text_input("Masukkan jumlah Minyak")
    Kadar PA minyak = st.text_input("Masukkan Kadar PA minyak")
    Lokasi = st.text_input("Masukkan Lokasi")
    ...
    if st.button("Tambah detail Qrcode"):
        add_minyaknilam(Id_Minyak_Nilam, Nama_Petani_Penyuling, Jenis_Penyulingan, Jumlah_minyak, Kadar PA minyak, Lokasi, Nama_Pengepul_12, Tanggal_Penjualan_ke_Pengepul_12)
        st.success("Pelacakan berhasil ditambahkan.")
...
def add_minyaknilam(Id_Minyak_Nilam, Nama_Petani_Penyuling, Jenis_Penyulingan, Jumlah_minyak, Lokasi, Kadar PA minyak, Nama_Pengepul_12, Tanggal_Penjualan_ke_Pengepul_12):
    try:
        with sqlite3.connect('data_nilam.db') as conn:
            cursor = conn.cursor()
            cursor.execute('INSERT INTO Table_Minyak_Nilam (Id_Minyak_Nilam, Nama_Petani_Penyuling, Jenis_Penyulingan, Jumlah_minyak, Lokasi, Kadar PA minyak, Nama_Pengepul_12, Tanggal_Penjualan_ke_Pengepul_12) VALUES (?, ?, ?, ?, ?, ?, ?, ?)', 
                           (Id_Minyak_Nilam, Nama_Petani_Penyuling, Jenis_Penyulingan, Jumlah_minyak, Kadar PA minyak, Lokasi, Nama_Pengepul_12, Tanggal_Penjualan_ke_Pengepul_12))
    except sqlite3.Error as e:
        st.error(f"Kesalahan database: {e}")
